            ...
            <div style={{ position: 'absolute', width: '100%', height: windowHeight, overflow: 'hidden' }}>
                ...
                <div id="chartpanel" style={{ width: 'calc(100% - 300px)', height: 'inherit', position: 'relative', float: 'right', overflow: 'hidden' }}>
                    ...
                    <div style={{ padding: '0', height: "calc(100% - 62px)", overflowY: 'auto' }}>
                        ...
                        {(this.state.tab == "Analytics" && (this.state.analytic != "FFT" && this.state.analytic != "HarmonicSpectrum") ?
                            <AnalyticLine yAxisLimits={this.state.yLimits} zoomMode={this.state.zoomMode} colorSettings={this.state.plotColors} unitSettings={this.state.plotUnits} pointTable={this.state.PointsTable} analytic={this.state.analytic} analyticParameter={this.state.AnalyticSettings} eventId={this.state.eventid} fftStartTime={this.state.fftStartTime} fftWindow={this.state.AnalyticSettings.fftWindow} startTime={this.state.startTime} endTime={this.state.endTime} stateSetter={this.stateSetter.bind(this)} height={height} hover={this.state.Hover} options={{ showXLabel: true }} /> : null)}
    ...
    return ( props.isCompare ? 
        <div className="card" style={{ height: (props.isCompare ? null : '100%') }}>
            ...
            <div className="card-body" style={{ padding: 0 }}>
                {(props.displayVolt ? <Voltage yAxisLimits={props.yAxisLimits} zoomMode={props.zoomMode} colorSettings={props.colorSettings} unitSettings={props.unitSettings} pointTable={props.pointTable} tableReset={props.tableReset} tableSetter={props.tableSetter} fftStartTime={props.fftStartTime} fftWindow={props.fftWindow} eventId={props.eventId} startTime={props.startTime} endTime={props.endTime} stateSetter={props.stateSetter} height={props.height} hover={props.hover} options={{ showXLabel: !(props.displayCur || props.displayDigitals || props.displayTCE || props.displayAnalogs) }} /> : null)}
                {(props.displayCur ? <Current yAxisLimits={props.yAxisLimits} zoomMode={props.zoomMode} colorSettings={props.colorSettings} unitSettings={props.unitSettings} pointTable={props.pointTable} tableReset={props.tableReset} tableSetter={props.tableSetter} fftStartTime={props.fftStartTime} fftWindow={props.fftWindow} eventId={props.eventId} startTime={props.startTime} endTime={props.endTime} stateSetter={props.stateSetter} height={props.height} hover={props.hover} options={{ showXLabel: !(props.displayDigitals || props.displayTCE || props.displayAnalogs) }} /> : null)}
                {(props.displayDigitals ? <Digital yAxisLimits={props.yAxisLimits} zoomMode={props.zoomMode} colorSettings={props.colorSettings} unitSettings={props.unitSettings} fftStartTime={props.fftStartTime} fftWindow={props.fftWindow} eventId={props.eventId}  startTime={props.startTime} endTime={props.endTime} stateSetter={props.stateSetter} height={props.height} hover={props.hover} options={{ showXLabel: !(props.displayTCE || props.displayAnalogs) }} /> : null)}
                {(props.displayAnalogs ? <Analog yAxisLimits={props.yAxisLimits} zoomMode={props.zoomMode} colorSettings={props.colorSettings} unitSettings={props.unitSettings} pointTable={props.pointTable} fftStartTime={props.fftStartTime} fftWindow={props.fftWindow} eventId={props.eventId}  startTime={props.startTime} endTime={props.endTime} stateSetter={props.stateSetter} height={props.height} hover={props.hover} options={{ showXLabel: !(props.displayTCE) }} /> : null)}
                {(props.displayTCE ? <TripCoilCurrent yAxisLimits={props.yAxisLimits} zoomMode={props.zoomMode} colorSettings={props.colorSettings} unitSettings={props.unitSettings} pointTable={props.pointTable} fftStartTime={props.fftStartTime} fftWindow={props.fftWindow} eventId={props.eventId}  startTime={props.startTime} endTime={props.endTime} stateSetter={props.stateSetter} height={props.height} hover={props.hover} options={{ showXLabel: true }} /> : null)}
            </div>
        </div>
        :
        <div>
            {(props.displayVolt ? <Voltage yAxisLimits={props.yAxisLimits} zoomMode={props.zoomMode} colorSettings={props.colorSettings} unitSettings={props.unitSettings} pointTable={props.pointTable} tableSetter={props.tableSetter} fftStartTime={props.fftStartTime} fftWindow={props.fftWindow} eventId={props.eventId}  startTime={props.startTime} endTime={props.endTime} stateSetter={props.stateSetter} height={props.height} hover={props.hover} options={{ showXLabel: !(props.displayCur || props.displayDigitals || props.displayTCE || props.displayAnalogs) }} /> : null)}
            {(props.displayCur ? <Current yAxisLimits={props.yAxisLimits} zoomMode={props.zoomMode} colorSettings={props.colorSettings} unitSettings={props.unitSettings} pointTable={props.pointTable} tableReset={props.tableReset} tableSetter={props.tableSetter} fftStartTime={props.fftStartTime} fftWindow={props.fftWindow} eventId={props.eventId}  startTime={props.startTime} endTime={props.endTime} stateSetter={props.stateSetter} height={props.height} hover={props.hover} options={{ showXLabel: !(props.displayDigitals || props.displayTCE || props.displayAnalogs) }} /> : null)}
            {(props.displayDigitals ? <Digital yAxisLimits={props.yAxisLimits} zoomMode={props.zoomMode} colorSettings={props.colorSettings} unitSettings={props.unitSettings} pointTable={props.pointTable} fftStartTime={props.fftStartTime} fftWindow={props.fftWindow} eventId={props.eventId}  startTime={props.startTime} endTime={props.endTime} stateSetter={props.stateSetter} height={props.height} hover={props.hover} options={{ showXLabel: !(props.displayTCE || props.displayAnalogs) }} /> : null)}
            {(props.displayAnalogs ? <Analog yAxisLimits={props.yAxisLimits} zoomMode={props.zoomMode} colorSettings={props.colorSettings} unitSettings={props.unitSettings} pointTable={props.pointTable} fftStartTime={props.fftStartTime} fftWindow={props.fftWindow} eventId={props.eventId} startTime={props.startTime} endTime={props.endTime} stateSetter={props.stateSetter} height={props.height} hover={props.hover} options={{ showXLabel: !(props.displayTCE) }} /> : null)}
            {(props.displayTCE ? <TripCoilCurrent yAxisLimits={props.yAxisLimits} zoomMode={props.zoomMode} colorSettings={props.colorSettings} unitSettings={props.unitSettings} pointTable={props.pointTable} fftStartTime={props.fftStartTime} fftWindow={props.fftWindow} eventId={props.eventId} startTime={props.startTime} endTime={props.endTime} stateSetter={props.stateSetter} height={props.height} hover={props.hover} options={{ showXLabel: true }} /> : null)}
        </div>
