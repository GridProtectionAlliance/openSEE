...
export type StandardAnalyticServiceFunction = (eventid: number) => JQuery.jqXHR
...
export default class OpenSEEService{
    ...
    getWaveformVoltageData(eventid: number): JQuery.jqXHR{
    ...
    getWaveformCurrentData(eventid: number): JQuery.jqXHR {
    ...
    getWaveformTCEData(eventid: number): JQuery.jqXHR {
    ...
    getFrequencyData(eventid: number, type: string): JQuery.jqXHR{
    ...
    getFaultDistanceData(eventid: number): JQuery.jqXHR{
    ...
    getDigitalsData(eventid: number): JQuery.jqXHR{
    ...
    getAnalogsData(eventid: number): JQuery.jqXHR {
    ...
    getImpedanceData(eventid: number): JQuery.jqXHR {
    ...
    getPowerData(eventid: number): JQuery.jqXHR {
    ...
    getFirstDerivativeData(eventid: number): JQuery.jqXHR {
    ...
    getRemoveCurrentData(eventid: number): JQuery.jqXHR {
    ...
    getMissingVoltageData(eventid: number): JQuery.jqXHR {
    ...
    getLowPassFilterData(eventid: number, filterorder: number): JQuery.jqXHR {
    ...
    getHighPassFilterData(eventid: number, filterorder: number): JQuery.jqXHR {
    ...
    getSymmetricalComponentsData(eventid: number): JQuery.jqXHR {
    ...
    getUnbalanceData(eventid: number): JQuery.jqXHR {
    ...
    getRectifierData(eventid: number,Trc: number): JQuery.jqXHR {
    ...
    getClippedWaveformData(eventid: number): JQuery.jqXHR {
    ...
    getRapidVoltageChangeData(eventid: number): JQuery.jqXHR {
    ...
    getTHDData(eventid: number): JQuery.jqXHR {
    ...
    getFrequencyAnalyticData(eventid: number): JQuery.jqXHR {
    ...
    getOverlappingWaveformData(eventid: number): JQuery.jqXHR {
