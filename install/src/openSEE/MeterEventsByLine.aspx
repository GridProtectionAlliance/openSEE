<%@ page language="C#" autoeventwireup="true" inherits="MeterEventsByLine, App_Web_xjlghq4y" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" src="./js/MeterEventsByLine.js?ver=<%=DateTime.Now.Ticks.ToString()%>"></script>
    ...
    <div class="gridheader"><center>Events for <%=postedMeterName%> for <%=postedDate%></center></div>
