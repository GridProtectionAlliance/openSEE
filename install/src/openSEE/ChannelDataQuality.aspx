<%@ page language="C#" autoeventwireup="true" inherits="ChannelDataQuality, App_Web_xjlghq4y" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" src="./js/ChannelDataQuality.js?ver=<%=DateTime.Now.Ticks.ToString()%>"></script>
